...
const CardForm = withStyles(formStyles)(
  class extends Component {
    constructor(props) {
      ...
      this.handleThankYouClickAway = this.handleThankYouClickAway.bind(this);
    }

    handleThankYouClickAway() {
      console.log("click away");
      this.setState({ thankOpen: false });
    }
    ...
    render() {
      const { name, email, phone, price, transaction, thankOpen } = this.state;
      ...
      return (
        <Fragment>
          ...
          <ClickawayPopper
            ...
            open={thankOpen}
            handleClickAway={this.handleThankYouClickAway}
            anchorEl={this.thankyouRef}
          >
